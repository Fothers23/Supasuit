...
<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
            ...
            <a class="nav-link" id="v-pills-profile-tab" data-toggle="pill" href="{{ route('discussion') }}" role="tab"
                aria-controls="v-pills-profile" aria-selected="false">Discussion</a>
            <a class="nav-link" id="v-pills-messages-tab" data-toggle="pill" href="{{ route('upcoming') }}" role="tab"
                aria-controls="v-pills-messages" aria-selected="false">Upcoming cons</a>
            <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="{{ route('tips') }}" role="tab"
